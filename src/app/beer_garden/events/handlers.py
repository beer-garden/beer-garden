...
def add_internal_events_handler(event_manager):
    for handler, handler_tag, local_only, filters, unique_data, enabled in [
        (
            ...
            config.get("events.garden.unique_data"),
            config.get("events.garden.enabled"),
        ),
        (
            ...
            False,
            [Events.INSTANCE_UPDATED],
            config.get("events.plugin.unique_data"),
            config.get("events.plugin.enabled"),
        ),
        (
            ...
            config.get("events.requests.unique_data"),
            config.get("events.requests.enabled"),
        ),
        (
        ...
        (
            ...
            config.get("events.system.unique_data"),
            config.get("events.system.enabled"),
        ),
        (
        ...
        (
            ...
            config.get("events.file.unique_data"),
            config.get("events.file.enabled"),
        ),
        (
