...
from beer_garden.api.brew_view.authorization import anonymous_principal as load_anonymous
...
def run():
    ...
    io_loop.add_callback(beer_garden.api.brew_view.startup)
...
def stop():
    ...
    io_loop.add_callback_from_signal(beer_garden.api.brew_view.shutdown)
...
async def startup():
    ...
    beer_garden.api.brew_view.logger.info("Application is started. Hello!")
...
def _setup_tornado_app():
    ...
    import beer_garden.api.brew_view.handlers.v1 as v1
    import beer_garden.api.brew_view.handlers.v2 as v2
    import beer_garden.api.brew_view.handlers.vbeta as vbeta
    import beer_garden.api.brew_view.handlers.misc as misc
