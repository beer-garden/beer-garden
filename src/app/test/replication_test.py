...
from beer_garden.replication import get_replication_id, create_replication, get_replications, update_replication
...
class TestReplication(object):
    ...
    def test_replication_expiration(self):
        create_replication(Replication(
                    replication_id="1111",
    ...
    def test_update_replication(self):
        replication = create_replication(Replication(
                    replication_id="1111",
