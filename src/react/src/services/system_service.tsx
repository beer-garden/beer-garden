...
export const GetSystemList = async (queryData?: any,headerData?: any): Promise<System[]> => {
    try {
        ...
        const response = await fetch(`/api/v1/systems?${queryString}`, { headers: headers });
        if (!response.ok) {
...
export const ExtractSystemsFromGardens = (gardens: Array<Garden>, systems: System[]): System[]=> {
