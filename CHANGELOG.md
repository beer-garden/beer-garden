...
- MongoDB Upgrade
- Request pruning handled by MongoDB
- Batching operations supported for MongoDB
- Configuration tracking between restarts
- Internal Performance Updates
- TEMP Request Mapping
- Elastic APM Support
...
- Reduced mongodb calls required to update instance heartbeat (#1831)
...
## Bug Fixes Backend (remove bug where)
...
- Fixed UI handling garden with null children (#1917)
- Fixed UI bug where Config was not loaded on all pages to properly display Garden Name or Tab titles (#1937)
- Fixed UI where missing Children on Garden model errored on isSystemRoutable UI filter (#1938)
