    ...
    'amq': {
        ...
        'items': {
            ...
            "heartbeat_interval": {
                ...
                "alt_env_names": ["BG_AMQ_HEARTBEAT_INTERVAL"],
            },
            "connection_attempts": {
                "type": "int",
                "default": 3,
                ...
                "alt_env_names": ["BG_AMQ_CONNECTION_ATTEMPTS"],
            },
            "exchange": {
                "type": "str",
                "default": "beer_garden",
            ...
            "virtual_host": {
                ...
                "alt_env_names": ["BG_AMQ_VIRTUAL_HOST"],
            },
            'connections': {
                'type': 'dict',
                'items': {
    ...
    "application": {
        ...
        'items': {
            "name": {
                ...
                "alt_env_names": ["BG_APPLICATION_NAME"],
            },
            "icon_default": {
                "type": "str",
            ...
            "allow_unsafe_templates": {
                ...
                "alt_env_names": ["BG_ALLOW_UNSANITIZED_TEMPLATES", "BG_ALLOW_UNSAFE_TEMPLATES"],
            },
        },
    },
    ...
    'backend': {
        ...
        'items': {
            ...
            "socket_timeout": {
                ...
                "alt_env_names": ["BG_BACKEND_SOCKET_TIMEOUT"],
            },
        },
    },
            ...
            'amq': {
                ...
                'items': {
                    ...
                    "exchange": {
                        ...
                        "alt_env_names": ["BG_EVENT_AMQ_EXCHANGE"],
                    },
                    "virtual_host": {
                        "type": "str",
                        "default": "/",
                        ...
                        "alt_env_names": ["BG_EVENT_AMQ_VIRTUAL_HOST"],
                    },
                },
            },
            'mongo': {
                ...
                'items': {
                    "enable": {
                        ...
                        "alt_env_names": ["BG_EVENT_PERSIST_MONGO"],
                    },
                },
            },
            "public_fqdn": {
    ...
    'plugin_logging': {
        ...
        'items': {
            "config_file": {
                ...
                "alt_env_names": ["BG_PLUGIN_LOG_CONFIG"],
            },
            "level": {
                "type": "str",
                ...
                "alt_env_names": ["BG_PLUGIN_LOG_LEVEL"],
            },
        },
    },
            ...
            'ssl': {
                ...
                'items': {
                    ...
                    "private_key": {
                        ...
                        "alt_env_names": ["BG_SSL_PRIVATE_KEY"],
                    },
                    "public_key": {
                        "type": "str",
                        ...
                        "alt_env_names": ["BG_SSL_PUBLIC_KEY"],
                    },
                    "ca_cert": {
                        "type": "str",
                    ...
                    "client_cert_verify": {
                        ...
                        "alt_env_names": ["BG_CLIENT_CERT_VERIFY"],
                    },
                },
            },
            "port": {
