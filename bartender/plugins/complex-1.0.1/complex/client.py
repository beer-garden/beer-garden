...
class ComplexClient:
    ...
    @parameter(key="b", type="Boolean", description="Just want to test Booleans", multi=False,
               display_name="A Boolean", optional=False, default=None, choices=None, model=None, nullable=False)
    def echo_bool(self, b):
        self.logger.info("Is Bool? : %s" % isinstance(b, bool))
        return b

    @parameter(key="b", type="Boolean", description="Testing a nullable boolean", multi=False, display_name="A boolean",
    ...
    @parameter(key="b", type="Boolean", description="Testing a Boolean with a false default", multi=False,
    ...
    @parameter(key="f", type="Float", description="Just want to test Floats", multi=False, display_name="A Float",
    ...
    @parameter(key="i", type="Integer", description="Just want to test Integers", multi=False,
               display_name="An Integer", optional=False, default=None, choices=None, model=None, nullable=False)
    def echo_integer(self, i):
        self.logger.info("%d" % i)
        return i

    @parameter(key="date", type="Date", nullable=True, display_name="Date", description="No time component, nullable")
    @parameter(key="datetime", type="DateTime", display_name="DateTime", description="Time component, not nullable")
    def echo_dates(self, date, datetime):
        return date, datetime

    @parameter(key="i", type="Integer", description="Just want to test Integers", multi=False,
               display_name="An Integer", optional=False, default=None, choices=list(range(1, 101)), model=None,
               nullable=False)
    def echo_integer_with_lots_of_choices(self, i):
        self.logger.info("%d" % i)
        return i

    @parameter(key="model", optional=False, description="A Model with a cool definition.", model=MyListModel)
    ...
    @parameter(key="list_of_b", type="Boolean", description="Testing List of Booleans", multi=True,
               display_name="A List of Booleans", optional=False, default=None, choices=None, model=None,
               nullable=False)
    ...
    @parameter(key="list_of_i", type="Integer", description="Testing List of Integers", multi=True,
               display_name="A List of Integers", optional=False, default=None, choices=None, model=None,
               nullable=False)
    ...
    @parameter(key="list_of_s", type="String", description="Testing List of Strings", multi=True,
               display_name="A List of Strings", optional=False, default=None, choices=None, model=None,
               nullable=False)
    ...
    @parameter(key="list_of_s", type="String", description="Testing List of Strings", multi=True,
               display_name="A List of Strings", optional=False, default=None, choices=['a', 'b', 'c'], model=None,
               nullable=False)
    ...
    @parameter(key="list_of_s", type="String", description="Testing List of Strings", multi=True,
               display_name="A List of Strings", optional=True, default=['a', 'b', 'c'], choices=None, model=None,
               nullable=False)
    ...
    @parameter(key="list_of_s", type="String", description="Testing List of Strings", multi=True,
               display_name="A List of Strings", optional=False, default=['a', 'b', 'c'], choices=None, model=None,
               nullable=False)
    ...
    @parameter(key="model", optional=False, description="A Model with a cool definition.", model=MyModel)
    def echo_model(self, model):
        for k, v in model.items():
            self.logger.info('{"%s" : %s}' % (k, v))
        return model

    @parameter(key="model", optional=True, nullable=True, description="A optional model.", model=MyModel)
    ...
    @parameter(key="models", optional=False, description="A List of Models", model=MyNestedModel, multi=True)
    ...
    @parameter(key="model", optional=False, description="A Model with a cool definition.", model=MyModelWithDefaults,
    ...
    @parameter(key="messages", optional=True, nullable=True, multi=True,
               description="This message could be any valid JSON value.", default=["a", 1, True, None])
    ...
    @parameter(key="message", optional=True, nullable=False, default="default required", type="String")
    ...
    @parameter(key='param', optional=True, nullable=True, multi=True, type='String', default=['hello', 'there'])
    ...
    @parameter(key="d", type="Dictionary", description="Testing a Blank Dictionary", multi=False,
               display_name="A Dictionary", optional=False, default=None, choices=None, model=None, nullable=False)
    ...
    @parameter(key="d", type="Dictionary", description="Testing a Blank Dictionary", multi=False,
               display_name="A Dictionary", optional=False, default=None, choices=None, model=None, nullable=True)
    ...
    @parameter(key="d", type="Dictionary", description="Testing a Blank Dictionary", multi=False,
               display_name="A Dictionary", optional=True, default=None, choices=None, model=None, nullable=True)
    ...
    @parameter(key="d", type="Dictionary", description="Testing a Blank Dictionary", multi=False,
               display_name="A Dictionary", optional=True, default={"foo": "bar"}, choices=None, model=None,
               nullable=False)
    ...
    @parameter(key="message", optional=False, nullable=False, default="cannot be null", type="String")
    ...
    @parameter(key="message", type="String", optional=False, nullable=True, regex=r'^Hi.*', default=None)
    def echo_required_nullable_message_regex(self, message=None):
        self.logger.info(message)
        return message

    @parameter(key="model", optional=False, description="A Model with a cool definition.", model=MyNestedModel)
    ...
    @parameter(key="s", type="String", description="Just want to test Small Choices", multi=False,
               display_name="A String", optional=False, default=None, choices=["a", "b", "c", "d", "e"], model=None,
               nullable=False)
    def echo_string_with_small_choices(self, s):
        self.logger.info("Is in choices?: %s" % (s in ['a', 'b', 'c', 'd', 'e']))
        return s

    @parameter(key="echo_max_value", type="Integer", description="Testing integer maximum constraint", multi=False,
    ...
    @parameter(key="echo_string", type="String", description="Testing string maximum constraint", multi=False,
    ...
    @parameter(key="echo_min_value", type="Integer", description="Testing integer minimum constraint", multi=False,
    ...
    @parameter(key="echo_string", type="String", description="Testing string minimum constraint", multi=False,
    ...
    @parameter(key="parameters", type="String", optional=False, nullable=False, multi=True, is_kwarg=True)
