    ...
    'plugin': {
        ...
        'items': {
            "status_heartbeat": {
                ...
                "alt_env_names": ["BG_PLUGIN_STATUS_HEARTBEAT"],
            },
            "status_timeout": {
                "type": "int",
                "default": 30,
                ...
                "alt_env_names": ["BG_PLUGIN_STATUS_TIMEOUT "],
            },
            'local': {
                'type': 'dict',
                'items': {
