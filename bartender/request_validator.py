...
class RequestValidator(object):
    ...
    def get_and_validate_parameters(self, request, command=None, command_parameters=None,
        ...
        if (value is not None and
            ...
            if choices.type == 'static':
                ...
                if isinstance(choices.value, six.string_types):
                    ...
                    response = self._client.send_bg_request(_command=parsed_value['name'],
                                                            _system_name=choices.value.get(
                                                                'system'),
                                                            _system_version=choices.value.get(
                                                                'version'),
                                                            _instance_name=choices.value.get(
                                                                'instance_name',
                                                                'default'),
                                                            **map_param_values(
                                                                parsed_value['args']))
