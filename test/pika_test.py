...
class PikaClientTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = PikaClient(host=self.host, port=self.port, user=self.user,
    ...
    def test_publish_request(self):
        ...
        self.publish_mock.assert_called_with('body', headers={'request_id': 'id'},
    ...
    def test_start(self, request_mock):
        ...
        publish_request_mock.assert_called_once_with(request_mock.return_value,
                                                     routing_key='admin.foo.1-0-0.default')
