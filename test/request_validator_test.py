...
class RequestTest(unittest.TestCase):
    ...
    def setUp(self):
        self.validator = RequestValidator(Mock(web_host='web_host', web_port=123, ssl_enabled=False, url_prefix=None,
    ...
    def test_get_and_validate_system_no_system(self):
        ...
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_system, req)
    ...
    def test_get_and_validate_command_none_provided(self):
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_command_for_system,
    ...
    def test_get_and_validate_command_for_system_bad_command_type(self):
        ...
        system = Mock(commands=[command])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_command_for_system,
                          Request(system='foo', command='command1', parameters={}, command_type='BAD'), system)
    ...
    def test_get_and_validate_command_for_system_bad_output_type(self):
        ...
        system = Mock(commands=[command])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_command_for_system,
                          Request(system='foo', command='command1', parameters={}, output_type='BAD'), system)
    ...
    def test_get_and_validate_parameters_bad_key_in_request_parameters(self):
        ...
        command = Mock(parameters=[])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, req, command)
    ...
    def test_get_and_validate_parameters_for_command_with_nested_parameters_not_provided(self):
        ...
        command_parameter = Mock(key="key1", multi=False, type="Dictionary", parameters=[nested_parameter])
    ...
    def test_get_and_validate_parameters_extract_parameter_non_multi_calls_no_default(self, validate_mock):
    ...
    @patch('bartender.request_validator.RequestValidator._validate_parameter_based_on_type')
    def test_get_and_validate_parameters_extract_parameter_non_multi_calls_with_default(self, validate_mock):
        req = Request(system='foo', command='command1', parameters={})
    ...
    def test_validate_value_in_choices_optional_none_allowed(self):
        req = Request(system='foo', command='command1', parameters={})
        command_parameter = Mock(key='key1', multi=False, type='String', optional=True, default=None,
    ...
    def test_validate_choices_static_dictionary_with_key_reference(self):
        ...
        command_parameter_1 = Mock(key='key1', multi=False, type='String', optional=False, default=None,
                                   choices=Mock(type='static', value=choices_value, details={'key_reference': 'key2'}),
                                   minimum=None, maximum=None, regex=None)
        command_parameter_2 = Mock(key='key2', multi=False, type='String', optional=False, default=None,
                                   choices=Mock(type='static', value=['a', 'b']), minimum=None, maximum=None,
                                   regex=None)
        ...
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, bad_req, command)
    ...
    def test_validate_choices_static_dictionary_no_key_reference_parameter_in_request_null_in_choices(self):
        choices_value = {'a': ['1', '2', '3'], 'b': ['4', '5', '6'], 'null': ['1']}

        command_parameter_1 = Mock(key='key1', multi=False, type='String', optional=False, default=None,
                                   choices=Mock(type='static', value=choices_value, details={'key_reference': 'key2'}),
                                   minimum=None, maximum=None, regex=None)
        command_parameter_2 = Mock(key='key2', multi=False, type='String', optional=True, default=None, nullable=True,
                                   choices=Mock(type='static', value=['a', 'b']), minimum=None, maximum=None,
                                   regex=None)
        command = Mock(parameters=[command_parameter_1, command_parameter_2])
    ...
    def test_validate_choices_static_dictionary_no_key_reference_parameter_in_request_no_null_in_choices(self):
        choices_value = {'a': ['1', '2', '3'], 'b': ['4', '5', '6']}
    ...
    def test_validate_choices_static_bad_type(self):
        command_parameter = Mock(key='key1', multi=False, type='String', optional=False, default=None,
                                 choices=Mock(type='static', value='bad str'), minimum=None, maximum=None, regex=None)
    ...
    def test_validate_url_choices(self):
        ...
        command_parameter = Mock(key='key1', type='String', optional=False, multi=False,
                                 choices=Mock(type='url', value='http://localhost'), minimum=None, maximum=None,
                                 regex=None)
        command = Mock(parameters=[command_parameter])
    ...
    def test_validate_command_choices_dict_value(self):
        ...
        choices_value = {'command': 'command_name', 'system': 'foo', 'version': '0.0.1', 'instance_name': 'default'}
        ...
        mock_client.send_bg_request.assert_called_with(_command='command_name', _system_name='foo',
                                                       _system_version='0.0.1', _instance_name='default')
    ...
    def test_validate_command_choices_bad_value_type(self):
        ...
        request = Request(system='foo', command='command1', parameters={'key1': 'value'},
                          system_version='0.0.1', instance_name='instance_name')
        command = Mock(parameters=[Parameter(key='key1', optional=False, choices=Choices(type='command', value=1))])

        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, request, command)
    ...
    def test_validate_command_choices_simple_list_response(self):
        ...
        request = Request(system='foo', command='command1', parameters={'key1': 'value'},
                          system_version='0.0.1', instance_name='instance_name')
        command = Mock(parameters=[Parameter(key='key1', choices=Choices(type='command', value='command_name'),
                                             optional=False)])

        self.validator.get_and_validate_parameters(request, command)
        mock_client.send_bg_request.assert_called_with(_command='command_name', _system_name='foo',
                                                       _system_version='0.0.1', _instance_name='instance_name')
    ...
    def test_validate_command_choices_bad_parameter(self):
        ...
        request = Request(system='foo', command='command1', parameters={'key1': 'value'},
                          system_version='0.0.1', instance_name='instance_name')
        command = Mock(parameters=[Parameter(key='key1', choices=Choices(type='foo', value='command_name'),
                                             optional=False)])
    ...
    def test_validate_maximum_sequence(self):
        ...
        command_parameter = Parameter(key='key1', multi=False, type='String', optional=False, maximum=10)
        command = Command('test', parameters=[command_parameter])
        self.validator.get_and_validate_parameters(req, command)

        command_parameter = Parameter(key='key1', multi=False, type='String', optional=False, maximum=3)
        command = Command('test', parameters=[command_parameter])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, req, command)
    ...
    def test_validate_maximum_non_sequence(self):
        ...
        command_parameter = Parameter(key='key1', multi=False, type='Integer', optional=False, maximum=10)
        command = Command('test', parameters=[command_parameter])
        self.validator.get_and_validate_parameters(req, command)

        command_parameter = Parameter(key='key1', multi=False, type='Integer', optional=False, maximum=3)
        command = Command('test', parameters=[command_parameter])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, req, command)
    ...
    def test_validate_minimum_sequence(self):
        ...
        command_parameter = Parameter(key='key1', multi=False, type='String', optional=False, minimum=3)
        command = Command('test', parameters=[command_parameter])
        self.validator.get_and_validate_parameters(req, command)

        command_parameter = Parameter(key='key1', multi=False, type='String', optional=False, minimum=10)
        command = Command('test', parameters=[command_parameter])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, req, command)
    ...
    def test_validate_minimum_non_sequence(self):
        ...
        command_parameter = Parameter(key='key1', multi=False, type='Integer', optional=False, minimum=3)
        command = Command('test', parameters=[command_parameter])
        self.validator.get_and_validate_parameters(req, command)

        command_parameter = Parameter(key='key1', multi=False, type='Integer', optional=False, minimum=10)
        command = Command('test', parameters=[command_parameter])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, req, command)
    ...
    def test_validate_regex(self):
        ...
        command_parameter = Parameter(key='key1', multi=False, type='String', optional=False, regex=r'^Hi.*')
        command = Command('test', parameters=[command_parameter])
        self.validator.get_and_validate_parameters(req, command)

        command_parameter = Parameter(key='key1', multi=False, type='String', optional=False, regex=r'^Hello.*')
        command = Command('test', parameters=[command_parameter])
        self.assertRaises(BrewmasterModelValidationError, self.validator.get_and_validate_parameters, req, command)

    def test_validate_regex_nullable(self):
        req = Request(system='foo', command='command1', parameters={'key1': None})
        command_parameter = Parameter(key='key1', multi=False, type='String', regex=r'^Hi.*', nullable=True)
        command = Command('test', parameters=[command_parameter])
        self.validator.get_and_validate_parameters(req, command)

    def test_validate_minimum_nullable(self):
        req = Request(system='foo', command='command1', parameters={'key1': None})
        command_parameter = Parameter(key='key1', multi=False, type='Integer', optional=False, minimum=3, nullable=True)
        command = Command('test', parameters=[command_parameter])
        self.validator.get_and_validate_parameters(req, command)
