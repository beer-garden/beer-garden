...
class PluginLoggingLoaderTest(unittest.TestCase):
    ...
    def test_load_no_file(self):
        config = self.loader.load(filename=None, level="INFO",
                                  default_config=self.python_config)
    ...
    def test_setup_application_logging_from_file(self, json_mock, open_mock):
        ...
        config = self.loader.load(filename="fake_file", level="INFO", default_config=None)
