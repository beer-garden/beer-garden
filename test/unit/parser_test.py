...
class ParserTest(unittest.TestCase):
    ...
    def test_parse_non_strict_failure(self):
        self.serialized_instance_dict['name'] = None
        self.parser.parse_instance(self.serialized_instance_dict, from_string=False, strict=False)
    ...
    def test_parse_instance_full(self):
        ...
        self.assertEqual(self.instance.status_info.heartbeat, parsed_instance.status_info.heartbeat)
    ...
    def test_serialize_instance_full(self):
        ...
        self.assertEqual(self.serialized_instance_dict['description'], instance['description'])
        self.assertEqual(self.serialized_instance_dict['status'], instance['status'])
        self.assertEqual(self.serialized_instance_dict['icon_name'], instance['icon_name'])
        self.assertDictEqual(self.serialized_instance_dict['queue_info'], instance['queue_info'])
        self.assertDictEqual(self.serialized_instance_dict['status_info'], instance['status_info'])
