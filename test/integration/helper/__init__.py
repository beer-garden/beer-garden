...
class RequestGenerator(object):
    ...
    def generate_request(self, **kwargs):
        namespace = self.get_or_raise(
            kwargs, "namespace", default=self.default_namespace, required=False
        )
        ...
        instance_name = self.get_or_raise(
            kwargs, "instance_name", default=self.default_instance_name
        )
        parameters = self.get_or_raise(
            kwargs, "parameters", default=self.default_parameters
        )
...
def get_config(is_child=False):
    ...
    if CONFIG is None:
        ...
        elif cwd.endswith("/beer-garden"):
            path = "test/integration/configs/"
