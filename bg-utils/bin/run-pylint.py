...
EXTRA_LIBS            = []
DISABLED_SETTINGS     = []
IGNORE_PATTERNS       = ["BartenderBackend.py", "ttypes.py", "constants.py", "SharedService.py"]
ADDITIONAL_PARAMETERS = ["--max-args=11", "--max-attributes=11", "--max-line-length=120", "--disable=bad-builtin,locally-disabled"]
