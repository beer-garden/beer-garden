...
export class RoleInfoHeader extends Component {
  renderTitle = () => {
    ...
    return (
      <>
        <Hidden xsDown>
          ...
          <Typography variant="h4">Role Information</Typography>
        </Hidden>
        <Hidden smUp>
...
export default enhance(RoleInfoHeader);
